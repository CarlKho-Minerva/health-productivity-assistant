...
Two submissions in one repo:

| Folder | What | Deadline |
|--------|------|----------|
| `track1/` | Single agent — health record query (Track 1 submission) | Mar 31, 2026 |
| `hackathon/` | Multi-agent system — health + tasks (Hackathon submission) | Apr 8, 2026 |
